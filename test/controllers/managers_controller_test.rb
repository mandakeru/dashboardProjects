...
class ManagersControllerTest < ActionController::TestCase
  ...
  test "should create manager" do
    assert_difference('Manager.count') do
      post :create, manager: { area: @manager.area, boss: @manager.boss, function: @manager.function, name: @manager.name }
    end
  ...
  test "should update manager" do
    patch :update, id: @manager, manager: { area: @manager.area, boss: @manager.boss, function: @manager.function, name: @manager.name }
    assert_redirected_to manager_path(assigns(:manager))
  end
